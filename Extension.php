...
class Extension extends \Bolt\BaseExtension
{
    ...
    function mapscript(){
        ...
        return "<script>if(document.getElementsByClassName('map-canvas').length > 0){document.write(\"<script src='".$basepath."vendor/sahassar/gmaps/assets/gmaps.js'><\/script>\")}</script>";
    }
